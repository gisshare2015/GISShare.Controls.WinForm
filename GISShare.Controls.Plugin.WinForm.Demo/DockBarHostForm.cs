...
{
    public partial class DockBarHostForm : GISShare.Controls.Plugin.WinForm.DockBar.HostDockBarForm, Hook.IAppHook
    {
        private readonly string LayoutFlie_DockBar = Application.StartupPath + "\\DockBar_DockBar.xml";
        private readonly string LayoutFlie_DockPanel = Application.StartupPath + "\\DockBar_DockPanel.xml";

        public DockBarHostForm()
        {
            InitializeComponent();
            //
            //
            ...
            {
                //你可以尝试取消注释看看效果哦
                //"GISShare.Controls.Plugin.LZHDemo.PluginDLL.WFNew.DockPanel.DockPanelLister"
            };
            //
            //
            //
            this.PluginReflection += new PluginReflectionEventHandler(DockBarHostForm_PluginReflection);
        ...
        void DockBarHostForm_PluginReflection(object sender, PluginReflectionEventArgs e)
        {
