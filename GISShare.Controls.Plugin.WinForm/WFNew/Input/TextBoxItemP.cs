...
{
    public class TextBoxItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, IBaseItemP_, ITextBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.TextBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.TextBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eTextBoxItem;
            }
        }
        #endregion
