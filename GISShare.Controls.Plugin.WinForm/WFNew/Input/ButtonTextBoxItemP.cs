...
{
    public class ButtonTextBoxItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, IBaseItemP_, ITextBoxItemP, IButtonTextBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ButtonTextBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ButtonTextBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eButtonTextBoxItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ButtonTextBoxItem CraeteButtonTextBoxItem(IButtonTextBoxItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ButtonTextBoxItem baseItem = new Controls.WinForm.WFNew.ButtonTextBoxItem();
