...
{
    public class IntegerInputBoxItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ITextBoxItemP, IIntegerInputBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.IntegerInputBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.IntegerInputBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eIntegerInputBoxItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.IntegerInputBoxItem CreateIntegerInputBoxItem(IIntegerInputBoxItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.IntegerInputBoxItem baseItem = new Controls.WinForm.WFNew.IntegerInputBoxItem();
