...
{
    public class CheckBoxItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ICheckBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.CheckBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.CheckBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eCheckBoxItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.CheckBoxItem CreateCheckBoxItem(ICheckBoxItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.CheckBoxItem baseItem = new Controls.WinForm.WFNew.CheckBoxItem();
