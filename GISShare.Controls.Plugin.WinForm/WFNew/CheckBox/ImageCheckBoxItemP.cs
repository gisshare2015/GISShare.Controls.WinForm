...
{
    public class ImageCheckBoxItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ICheckBoxItemP, ILabelItemP, IImageBoxItemP, IImageLabelItemP, IImageCheckBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ImageCheckBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ImageCheckBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eImageCheckBoxItem;
            }
        }
        #endregion
