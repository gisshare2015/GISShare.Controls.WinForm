...
{
    public class RatingStarItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IRatingStarItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.RatingStarItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.RatingStarItemP";
        ...
        protected int _StarCount = 5;
        protected int _StarSize = 14;
        protected int _StarSpace = 3;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eRatingStarItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.RatingStarItem CreateRatingStarItem(IRatingStarItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.RatingStarItem baseItem = new Controls.WinForm.WFNew.RatingStarItem();
            ...
            //IRatingStarItemP
            baseItem.StarCount = pBaseItemP.StarCount;
            baseItem.Value = pBaseItemP.Value;
            baseItem.StarSize = pBaseItemP.StarSize;
            baseItem.StarSpace = pBaseItemP.StarSpace;
