...
{
    public class CheckButtonExItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IBaseButtonExItemP, ICheckButtonExItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.CheckButtonExItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.CheckButtonExItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eCheckButtonExItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.CheckButtonExItem CreateCheckButtonExItem(ICheckButtonExItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.CheckButtonExItem baseItem = new Controls.WinForm.WFNew.CheckButtonExItem();
