...
{
    public class SplitButtonItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IDropDownButtonItemP, ISplitButtonItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.SplitButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.SplitButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eSplitButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.SplitButtonItem CreateSplitButtonItem(ISplitButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.SplitButtonItem baseItem = new Controls.WinForm.WFNew.SplitButtonItem();
