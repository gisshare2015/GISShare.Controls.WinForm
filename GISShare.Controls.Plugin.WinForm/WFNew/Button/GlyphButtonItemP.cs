...
{
    public class GlyphButtonItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IGlyphButtonItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.GlyphButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.GlyphButtonItemP";
        ...
        //
        protected GISShare.Controls.WinForm.WFNew.GlyphStyle _eGlyphStyle = Controls.WinForm.WFNew.GlyphStyle.ePointsHorizontal;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eGlyphButtonItem;
            }
        }
        #endregion
        ...
        #region IGlyphButtonItemP
        public GISShare.Controls.WinForm.WFNew.GlyphStyle eGlyphStyle
        {
            get { return _eGlyphStyle; }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.GlyphButtonItem CreateGlyphButtonItem(IGlyphButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.GlyphButtonItem baseItem = new Controls.WinForm.WFNew.GlyphButtonItem();
            ...
            //IGlyphButtonItemP
            baseItem.eGlyphStyle = pBaseItemP.eGlyphStyle;
