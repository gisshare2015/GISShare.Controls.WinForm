...
{
    public class DropDownButtonExItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IDropDownButtonItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.DropDownButtonExItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.DropDownButtonExItemP";
        ...
        //
        protected int _DropDownDistance = 15;
        protected GISShare.Controls.WinForm.WFNew.ArrowStyle _eArrowStyle = GISShare.Controls.WinForm.WFNew.ArrowStyle.eToDown;
        ...
        protected System.Drawing.Size _ArrowSize = new System.Drawing.Size(3, 3);
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eDropDownButtonExItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.DropDownButtonExItem CreateDropDownButtonExItem(IDropDownButtonExItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.DropDownButtonExItem baseItem = new Controls.WinForm.WFNew.DropDownButtonExItem();
