...
{
    public class BaseButtonExItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IBaseButtonExItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.BaseButtonExItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.BaseButtonExItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eBaseButtonExItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.BaseButtonExItem CreateBaseButtonExItem(IBaseButtonExItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.BaseButtonExItem baseItem = new Controls.WinForm.WFNew.BaseButtonExItem();
