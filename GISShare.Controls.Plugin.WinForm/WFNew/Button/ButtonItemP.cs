...
{
    public class ButtonItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IDropDownButtonItemP, ISplitButtonItemP, IButtonItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ButtonItem CreateButtonItem(IButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ButtonItem baseItem = new Controls.WinForm.WFNew.ButtonItem();
