...
{
    public class SplitButtonExItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IDropDownButtonItemP, ISplitButtonItemP, ISplitButtonExItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.SplitButtonExItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.SplitButtonExItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eSplitButtonExItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.SplitButtonExItem CreateSplitButtonExItem(ISplitButtonExItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.SplitButtonExItem baseItem = new Controls.WinForm.WFNew.SplitButtonExItem();
