...
{
    public class CheckButtonItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, ICheckButtonItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.CheckButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.CheckButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eCheckButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.CheckButtonItem CreateCheckButtonItem(ICheckButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.CheckButtonItem baseItem = new Controls.WinForm.WFNew.CheckButtonItem();
