...
{
    public class DropDownButtonItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP, IDropDownButtonItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.DropDownButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.DropDownButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eDropDownButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.DropDownButtonItem CreateDropDownButtonItem(IDropDownButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.DropDownButtonItem baseItem = new Controls.WinForm.WFNew.DropDownButtonItem();
