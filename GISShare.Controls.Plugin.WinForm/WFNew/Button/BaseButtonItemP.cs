...
{
    public class BaseButtonItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, IBaseButtonItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.BaseButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.BaseButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eBaseButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.BaseButtonItem CreateBaseButtonItem(IBaseButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.BaseButtonItem baseItem = new Controls.WinForm.WFNew.BaseButtonItem();
