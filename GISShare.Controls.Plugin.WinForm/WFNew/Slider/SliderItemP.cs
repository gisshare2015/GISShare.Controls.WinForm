...
{
    public class SliderItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ISliderItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.SliderItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.SliderItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eSliderItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.SliderItem CreateSliderItem(ISliderItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.SliderItem baseItem = new Controls.WinForm.WFNew.SliderItem();
