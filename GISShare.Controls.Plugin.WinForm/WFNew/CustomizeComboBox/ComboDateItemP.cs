...
{
    public class ComboDateItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ITextBoxItemP, ICustomizeComboBoxItemP_, IComboDateItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ComboDateItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ComboDateItemP";
        ...
        //
        protected DateTime _SelectedDate = System.DateTime.Now;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eComboDateItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ComboDateItem CreateComboDateItem(IComboDateItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ComboDateItem baseItem = new Controls.WinForm.WFNew.ComboDateItem();
            ...
            //IComboDateItemP
            baseItem.SelectedDate = pBaseItemP.SelectedDate;
