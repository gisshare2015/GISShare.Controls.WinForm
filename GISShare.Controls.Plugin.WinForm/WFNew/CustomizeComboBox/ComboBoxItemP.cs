...
{
    public class ComboBoxItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ITextBoxItemP, ICustomizeComboBoxItemP_, ICheckedComboBoxItemP_, IComboBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ComboBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ComboBoxItemP";
        ...
        protected GISShare.Controls.WinForm.WFNew.View.ViewItem[] _Items = null;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eComboBoxItem;
            }
        }
        #endregion
        ...
        #region IComboBoxItemP
        public int SelectedIndex
        {
            get { return _SelectedIndex; }
        }

        public GISShare.Controls.WinForm.WFNew.View.ViewItem[] Items
        {
            get { return _Items; }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ComboBoxItem CreateComboBoxItem(IComboBoxItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ComboBoxItem baseItem = new Controls.WinForm.WFNew.ComboBoxItem();
            ...
            {
                baseItem.Items.Add(pBaseItemP.Items[i]);
            }
            baseItem.SelectedIndex = pBaseItemP.SelectedIndex;
