...
{
    public class ImageBoxItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IImageBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ImageBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ImageBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eImageBoxItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ImageBoxItem CreateImageBoxItem(IImageBoxItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ImageBoxItem baseItem = new Controls.WinForm.WFNew.ImageBoxItem();
