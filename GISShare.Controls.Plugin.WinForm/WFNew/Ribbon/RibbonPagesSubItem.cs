...
{
    public class RibbonPagesSubItem : IPlugin, IPluginInfo, ISubItem
    {
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.Ribbon.RibbonPagesSubItem";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_3_Style.eRibbonControlEx_RibbonPages;
            }
        }
        #endregion
