...
{
    public class MenuItemsSubItem : IPlugin, IPluginInfo, ISubItem
    {
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.Ribbon.MenuItemsSubItem";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_3_Style.eRibbonControlEx_ApplicationPopup_MenuItems;
            }
        }
        #endregion
