...
{
    public class ToolbarItemsSubItem : IPlugin, IPluginInfo , ISubItem
    {
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.Ribbon.ToolbarItemsSubItem";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_3_Style.eRibbonControlEx_ToolbarItems;
            }
        }
        #endregion
