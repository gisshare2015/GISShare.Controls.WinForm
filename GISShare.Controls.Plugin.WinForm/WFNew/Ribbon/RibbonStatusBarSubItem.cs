...
{
    public class RibbonStatusBarSubItem : IPlugin, IPluginInfo, ISubItem
    {
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.Ribbon.RibbonStatusBarSubItem";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_3_Style.eRibbonStatusBar_BaseItems;
            }
        }
        #endregion
