...
{
    public class BaseItemStackItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IBaseItemStackItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.BaseItemStackItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.BaseItemStackItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eBaseItemStackItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.BaseItemStackItem CreateBaseItemStackItem(IBaseItemStackItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.BaseItemStackItem baseItem = new Controls.WinForm.WFNew.BaseItemStackItem();
