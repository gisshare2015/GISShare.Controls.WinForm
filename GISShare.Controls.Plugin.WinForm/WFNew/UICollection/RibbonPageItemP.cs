...
{
    public class RibbonPageItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IBaseItemStackItemP, IBaseItemStackExItemP, IRibbonPageItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.IRibbonPageItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.IRibbonPageItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eRibbonPageItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.RibbonPageItem CreateRibbonPageItem(IRibbonPageItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.RibbonPageItem baseItem = new Controls.WinForm.WFNew.RibbonPageItem();
