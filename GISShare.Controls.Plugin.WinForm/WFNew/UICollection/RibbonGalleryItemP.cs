...
{
    public class RibbonGalleryItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IBaseItemStackItemP, IRibbonGalleryItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.GalleryItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.GalleryItemP";
        ...
        protected bool _UpButtonIncreaseIndex = true;
        //
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eRibbonGalleryItem;
            }
        }
        #endregion
        ...
        {
            get { return _UpButtonIncreaseIndex; }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.RibbonGalleryItem CreateRibbonGalleryItem(IRibbonGalleryItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.RibbonGalleryItem baseItem = new Controls.WinForm.WFNew.RibbonGalleryItem();
            ...
            baseItem.UpButtonIncreaseIndex = pBaseItemP.UpButtonIncreaseIndex;
