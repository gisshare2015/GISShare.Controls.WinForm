...
{
    public class RibbonGalleryRowItemP : IPlugin,IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IBaseItemStackItemP, IRibbonGalleryRowItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.RibbonGalleryRowItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.RibbonGalleryRowItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eRibbonGalleryRowItem;
            }
        }
        #endregion
        ...
        //
        //
        public static GISShare.Controls.WinForm.WFNew.RibbonGalleryRowItem CreateRibbonGalleryRowItem(IRibbonGalleryRowItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.RibbonGalleryRowItem baseItem = new Controls.WinForm.WFNew.RibbonGalleryRowItem();
