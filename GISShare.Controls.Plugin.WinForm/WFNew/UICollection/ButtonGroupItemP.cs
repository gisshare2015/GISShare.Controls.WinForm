...
{
    public class ButtonGroupItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IBaseItemStackItemP, IButtonGroupItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ButtonGroupItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ButtonGroupItemP";
        ...
        protected bool _IsStretchItems = false;
        ...
        //
        protected bool _ShowNomalState = true;
        protected bool _UseButtonGroupRadius = true;
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eButtonGroupItem;
            }
        }
        #endregion
        ...
        {
            get { return _UseButtonGroupRadius; }
        }
        ...
        public static GISShare.Controls.WinForm.WFNew.ButtonGroupItem CreateButtonGroupItem(IButtonGroupItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ButtonGroupItem baseItem = new Controls.WinForm.WFNew.ButtonGroupItem();
            ...
            baseItem.UseButtonGroupRadius = pBaseItemP.UseButtonGroupRadius;
