...
{
    public class ContextPopupP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IContextPopupP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ContextPopupP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ContextPopupP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eContextPopup;
            }
        }
        #endregion
