...
{
    public class LabelItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.LabelItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.LabelItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eLabelItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.LabelItem CreateLabelItem(ILabelItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.LabelItem baseItem = new Controls.WinForm.WFNew.LabelItem();
