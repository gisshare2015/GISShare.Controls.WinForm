...
{
    public class ImageLinkLabelItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, ILinkLabelItemP, IImageLabelItemP, IImageLinkLabelItemP, IImageBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ImageLinkLabelItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ImageLinkLabelItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eImageLinkLabelItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ImageLinkLabelItem CreateImageLinkLabelItem(IImageLinkLabelItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ImageLinkLabelItem baseItem = new Controls.WinForm.WFNew.ImageLinkLabelItem();
