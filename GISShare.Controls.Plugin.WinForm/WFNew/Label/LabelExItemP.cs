...
{
    public class LabelExItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, ILabelExItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.LabelExItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.LabelExItemP";
        ...
        //
        protected bool _IsMultipleLine = true;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eLabelExItem;
            }
        }
        #endregion
        ...
        #region ILabelExItemP
        public bool IsMultipleLine
        {
            get { return _IsMultipleLine; }
        }
        #endregion
