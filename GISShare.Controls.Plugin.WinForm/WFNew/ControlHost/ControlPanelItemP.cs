...
{
    public class ControlPanelItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IControlPanelItemP
    {
        #region 私有属性
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eControlPanelItem;
            }
        }
        #endregion
