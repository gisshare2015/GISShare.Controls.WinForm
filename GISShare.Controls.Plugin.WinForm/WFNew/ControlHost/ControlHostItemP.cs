...
{
    public class ControlHostItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IControlHostItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ControlHostItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ControlHostItemP";
        ...
        //
        protected System.Windows.Forms.Control _ControlObject = null;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eControlHostItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ControlHostItem CreateControlHostItem(IControlHostItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ControlHostItem baseItem = new Controls.WinForm.WFNew.ControlHostItem();
            ...
            //IControlHostItemP
            baseItem.ControlObject = pBaseItemP.ControlObject;
