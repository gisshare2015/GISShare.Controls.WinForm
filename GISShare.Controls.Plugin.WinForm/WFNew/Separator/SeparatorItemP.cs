...
{
    public class SeparatorItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ISeparatorItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.SeparatorItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.SeparatorItemP";
        ...
        //
        protected int _LineSpace = 6;
        protected bool _BaseItemStateEnable = false;
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eSeparatorItem;
            }
        }
        #endregion
        ...
        {
            get { return _BaseItemStateEnable; }
        }
        ...
        public static  GISShare.Controls.WinForm.WFNew.SeparatorItem CreateSeparatorItem(ISeparatorItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.SeparatorItem baseItem = new Controls.WinForm.WFNew.SeparatorItem();
            ...
            baseItem.LineSpace = pBaseItemP.LineSpace;
            baseItem.AutoLayout = pBaseItemP.AutoLayout;
            baseItem.BaseItemStateEnable = pBaseItemP.BaseItemStateEnable;
