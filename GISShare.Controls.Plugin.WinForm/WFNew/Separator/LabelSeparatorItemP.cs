...
{
    public class LabelSeparatorItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, ILabelSeparatorItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.LabelSeparatorItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.LabelSeparatorItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eLabelSeparatorItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.LabelSeparatorItem CreateLabelSeparatorItem(ILabelSeparatorItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.LabelSeparatorItem baseItem = new Controls.WinForm.WFNew.LabelSeparatorItem();
