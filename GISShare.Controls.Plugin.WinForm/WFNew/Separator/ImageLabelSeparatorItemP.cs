...
{
    public class ImageLabelSeparatorItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageLabelItemP, IImageBoxItemP, ILabelSeparatorItemP, IImageLabelSeparatorItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ImageLabelSeparatorItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ImageLabelSeparatorItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eImageLabelSeparatorItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ImageLabelSeparatorItem CreateImageLabelSeparatorItem(IImageLabelSeparatorItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ImageLabelSeparatorItem baseItem = new Controls.WinForm.WFNew.ImageLabelSeparatorItem();
