...
{
    public class ImageRadioButtonItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, ILabelItemP, IImageBoxItemP, IImageLabelItemP, IImageRadioButtonItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.ImageRadioButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.ImageRadioButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eImageRadioButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.ImageRadioButtonItem CreateImageRadioButtonItem(IImageRadioButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.ImageRadioButtonItem baseItem = new Controls.WinForm.WFNew.ImageRadioButtonItem();
