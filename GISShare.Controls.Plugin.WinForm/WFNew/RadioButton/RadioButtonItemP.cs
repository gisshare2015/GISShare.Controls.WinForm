...
{
    public class RadioButtonItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemP_, IRadioButtonItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.WFNew.RadioButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.WFNew.RadioButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_1_Style.eRadioButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.WFNew.RadioButtonItem CreateRadioButtonItem(IRadioButtonItemP pBaseItemP)
        {
            GISShare.Controls.WinForm.WFNew.RadioButtonItem baseItem = new Controls.WinForm.WFNew.RadioButtonItem();
