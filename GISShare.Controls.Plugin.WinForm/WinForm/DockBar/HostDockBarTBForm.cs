...
{
    public class HostDockBarTBForm : GISShare.Controls.WinForm.WFNew.Forms.TBForm, GISShare.Controls.Plugin.IBaseHost, GISShare.Controls.Plugin.IBaseHost2
    {
        /// <summary>
        /// 记录插件加载和反射的事件
        /// </summary>
            ...
            GISShare.Controls.WinForm.WFNew.DockPanel.DockPanelManager dockPanelManager)
        {
            ...
            {
                this.m_HostDockBarObject = new HostDockBarObject(pluginDLLFolder, strFilterFilePathArray, bFilterFilePathArrayTypeRemove, strFilterObjectNameArray, bFilterObjectNameArrayTypeRemove, hook, this, dockBarManager, dockPanelManager);
        ...
        public void AppendPlugin()
        {
            if (this.m_HostDockBarObject != null)
            {
                AppendPluginForm2 appendPluginForm = new AppendPluginForm2(this.m_HostDockBarObject);
        ...
        public void UIView()
        {
            if (this.m_HostDockBarObject != null)
            {
                UIViewTBForm uiViewForm = new UIViewTBForm(this.m_HostDockBarObject.UIView());
