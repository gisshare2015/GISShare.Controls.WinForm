...
{
    public class StatusBarP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IDockBarP_, IStatusBarP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.StatusBarP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.StatusBarP";
        ...
        protected System.Windows.Forms.DockStyle _DockStyle = System.Windows.Forms.DockStyle.Bottom;
        ...
        protected System.Windows.Forms.ToolStripGripStyle _GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eStatusBar;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.StatusBar CreateStatusBar(GISShare.Controls.Plugin.WinForm.DockBar.IStatusBarP pDockBarP)
        {
            GISShare.Controls.WinForm.DockBar.StatusBar baseItem = new Controls.WinForm.DockBar.StatusBar();
