...
{
    public class DropDownButtonItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, IDropDownButtonItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.DropDownButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.DropDownButtonItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.DropDownButtonItemP";
        ...
        //
        protected bool _ShowDropDownArrow = true;
        //
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eDropDownButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.DropDownButtonItem CreateDropDownButtonItem(GISShare.Controls.Plugin.WinForm.DockBar.IDropDownButtonItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.DropDownButtonItem baseItem = new Controls.WinForm.DockBar.DropDownButtonItem();
            ...
            //
            baseItem.ShowDropDownArrow = pBaseItemDBP.ShowDropDownArrow;
