...
{
    public class SeparatorItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, ISeparatorItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.SeparatorItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.SeparatorItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.SeparatorItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eSeparatorItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.SeparatorItem CreateSeparatorItem(GISShare.Controls.Plugin.WinForm.DockBar.ISeparatorItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.SeparatorItem baseItem = new Controls.WinForm.DockBar.SeparatorItem();
