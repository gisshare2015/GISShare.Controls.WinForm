...
{
    public class ComboBoxItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, IComboBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.ComboBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.ComboBoxItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.ComboBoxItemP";
        ...
        protected System.Windows.Forms.ComboBoxStyle _DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDown;
        protected object[] _Items = new object[] { };
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eComboBoxItem;
            }
        }
        #endregion
