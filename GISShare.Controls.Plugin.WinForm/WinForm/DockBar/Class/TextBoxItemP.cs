...
{
    public class TextBoxItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, ITextBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.TextBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.TextBoxItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.TextBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eTextBoxItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.TextBoxItem CreateTextBoxItem(GISShare.Controls.Plugin.WinForm.DockBar.ITextBoxItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.TextBoxItem baseItem = new Controls.WinForm.DockBar.TextBoxItem();
            ...
            //
            baseItem.PasswordChar = pBaseItemDBP.PasswordChar;
