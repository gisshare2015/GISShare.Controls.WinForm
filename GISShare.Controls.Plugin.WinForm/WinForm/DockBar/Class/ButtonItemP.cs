...
{
    public class ButtonItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, IButtonItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.ButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.ButtonItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.ButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.ButtonItem CreateButtonItem(GISShare.Controls.Plugin.WinForm.DockBar.IButtonItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.ButtonItem baseItem = new Controls.WinForm.DockBar.ButtonItem();
