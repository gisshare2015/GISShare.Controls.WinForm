...
{
    public class ProgressBarItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, IProgressBarItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.ProgressBarItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.ProgressBarItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.ProgressBarItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eProgressBarItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.ProgressBarItem CreateProgressBarItem(GISShare.Controls.Plugin.WinForm.DockBar.IProgressBarItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.ProgressBarItem baseItem = new Controls.WinForm.DockBar.ProgressBarItem();
            ...
            baseItem.Step = pBaseItemDBP.Step;
