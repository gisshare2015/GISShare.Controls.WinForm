...
{
    public class LabelItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, ILabelItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.LabelItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.LabelItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.LabelItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eLabelItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.LabelItem CreateLabelItem(GISShare.Controls.Plugin.WinForm.DockBar.ILabelItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.LabelItem baseItem = new Controls.WinForm.DockBar.LabelItem();
            ...
            //
            baseItem.IsLink = pBaseItemDBP.IsLink;
