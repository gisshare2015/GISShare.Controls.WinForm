...
{
    public class CheckBoxItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, ICheckBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.CheckBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.CheckBoxItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.CheckBoxItemP";
        ...
        //
        protected int _VOffset = 3;
        protected bool _Checked = false;
        protected System.Windows.Forms.CheckState _CheckState = System.Windows.Forms.CheckState.Unchecked;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eCheckBoxItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.CheckBoxItem CreateCheckBoxItem(GISShare.Controls.Plugin.WinForm.DockBar.ICheckBoxItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.CheckBoxItem baseItem = new Controls.WinForm.DockBar.CheckBoxItem();
            ...
            //
            baseItem.VOffset = pBaseItemDBP.VOffset;
