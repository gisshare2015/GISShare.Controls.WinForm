...
{
    public class MenuItemP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, IMenuItemP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.MenuItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.MenuItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.MenuItemP";
        ...
        protected bool _CheckOnClick = false;
        protected System.Windows.Forms.CheckState _CheckState = System.Windows.Forms.CheckState.Unchecked;
        protected string _ShortcutKeyDisplayString = "";
        protected System.Windows.Forms.Keys _ShortcutKeys = System.Windows.Forms.Keys.None;
        protected bool _ShowShortcutKeys = false;
        //
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eMenuItem;
            }
        }
        #endregion
