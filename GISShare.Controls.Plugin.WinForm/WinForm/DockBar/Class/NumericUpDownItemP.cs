...
{
    public class NumericUpDownItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, INumericUpDownItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.NumericUpDownItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.NumericUpDownItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.NumericUpDownItemP";
        ...
        //
        protected decimal _Maximum = int.MaxValue;
        protected decimal _Minimum = int.MinValue;
        protected decimal _Value = 0;
        protected decimal _Increment = 1;
        #endregion
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eNumericUpDownItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.NumericUpDownItem CreateNumericUpDownItem(GISShare.Controls.Plugin.WinForm.DockBar.INumericUpDownItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.NumericUpDownItem baseItem = new Controls.WinForm.DockBar.NumericUpDownItem();
            ...
            //
            baseItem.Maximum = pBaseItemDBP.Maximum;
            baseItem.Minimum = pBaseItemDBP.Minimum;
            baseItem.Value = pBaseItemDBP.Value;
            baseItem.Increment = pBaseItemDBP.Increment;
