...
{
    public class RadioButtonItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, IRadioButtonItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.RadioButtonItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.RadioButtonItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.RadioButtonItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eRadioButtonItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.RadioButtonItem CreateRadioButtonItem(GISShare.Controls.Plugin.WinForm.DockBar.IRadioButtonItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.RadioButtonItem baseItem = new Controls.WinForm.DockBar.RadioButtonItem();
