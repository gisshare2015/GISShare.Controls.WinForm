...
{
    public class MaskedTextBoxItemP : IPlugin, IPluginInfo, IEventChain, IPlugin2, ISetEntityObject, IBaseItemDBP_, IMaskedTextBoxItemP
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.MaskedTextBoxItemP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.MaskedTextBoxItemP";
        protected string _ToolTipText = "GISShare.Controls.Plugin.WinForm.DockBar.MaskedTextBoxItemP";
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eMaskedTextBoxItem;
            }
        }
        #endregion
        ...
        public static GISShare.Controls.WinForm.DockBar.MaskedTextBoxItem CreateMaskedTextBoxItem(GISShare.Controls.Plugin.WinForm.DockBar.IMaskedTextBoxItemP pBaseItemDBP)
        {
            GISShare.Controls.WinForm.DockBar.MaskedTextBoxItem baseItem = new Controls.WinForm.DockBar.MaskedTextBoxItem();
