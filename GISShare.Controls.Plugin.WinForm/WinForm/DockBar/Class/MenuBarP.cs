...
{
    public class MenuBarP : IPlugin, IPluginInfo , IEventChain, IPlugin2, ISetEntityObject, IDockBarP_, IMenuBarP, ISubItem
    {
        #region 私有属性
        ...
        #region 受保护的属性
        protected string _Name = "GISShare.Controls.Plugin.WinForm.DockBar.MenuBarP";
        //
        protected string _Text = "GISShare.Controls.Plugin.WinForm.DockBar.MenuBarP";
        ...
        protected bool _CanOverflow = false;
        //
        ...
        public int CategoryIndex
        {
            get
            {
                return (int)CategoryIndex_5_Style.eMenuBar;
            }
        }
        #endregion
