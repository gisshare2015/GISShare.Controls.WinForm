...
{
    [ToolboxItem(false), Designer(typeof(MenuBarDesigner)), ToolboxBitmap(typeof(MenuBar), "DockBar.bmp")]
    public class MenuBar : System.Windows.Forms.MenuStrip, IDockBar, ICollectionItemDB, ICustomize, IDock, WFNew.IRecordItem, WFNew.ISetRecordItemHelper, ISetDockBarManagerHelper, WFNew.IObjectDesignHelper, WFNew.ICollectionObjectDesignHelper
    {
            ...
            : base()
        {
            ...
            base.GripStyle = ToolStripGripStyle.Visible;
            base.RenderMode = ToolStripRenderMode.ManagerRenderMode;
        }

        //public MenuBar(GISShare.Controls.Plugin.WinForm.DockBar.IMenuBarP pDockBarP)
        //    : this()
        //{
        //    //IPlugin
        ...
        { get { return DockBarStyle.eMenuBar; } }
