...
namespace GISShare.Controls.WinForm.DockBar
{
    public class StatusBarDesigner : ControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            //
            this.m_StatusBar = base.Component as StatusBar;
            if (this.m_StatusBar == null)
            {
                this.DisplayError(new ArgumentException("StatusBar == null"));
                return;
            }
        }
        ...
        {
            BaseItemDBCollectionDesignerForm baseItemDBCollectionDesignerForm = new BaseItemDBCollectionDesignerForm(this.m_StatusBar);
