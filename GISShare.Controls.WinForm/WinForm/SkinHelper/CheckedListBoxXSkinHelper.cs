...
{
    public class CheckedListBoxXSkinHelper : ControlSkinHelper, ICheckedListBoxX, WinForm.IItemOwner
    {
        ...
        private CheckedListBox m_HostCheckedListBox;

        public CheckedListBoxXSkinHelper(CheckedListBox hostCheckedListBox)
            : base(hostCheckedListBox)
        {
            this.m_HostCheckedListBox = hostCheckedListBox;
            //
            this.m_HostCheckedListBox.MouseMove += new MouseEventHandler(HostCheckedListBox_MouseMove);
            this.m_HostCheckedListBox.MouseLeave += new EventHandler(HostCheckedListBox_MouseLeave);
            //
            this.m_HostCheckedListBox.SelectedIndexChanged += new EventHandler(HostCheckedListBox_SelectedIndexChanged);
        }
        ...
        public Color BackColor
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return Color.White;
                return this.m_HostCheckedListBox.BackColor;
            }
            set
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return;
                this.m_HostCheckedListBox.BackColor = value;
            }
        }
        ...
        public BorderStyle BorderStyle
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return BorderStyle.Fixed3D;
                return this.m_HostCheckedListBox.BorderStyle;
            }
        }
        ...
        public int ColumnWidth
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return 120;
                return this.m_HostCheckedListBox.ColumnWidth;
            }
        }
        ...
        public DrawMode DrawMode
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return DrawMode.OwnerDrawFixed;
                return this.m_HostCheckedListBox.DrawMode;
            }
        }
        ...
        public int ItemHeight
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return 12;
                return this.m_HostCheckedListBox.ItemHeight;
            }
        }
        ...
        public CheckedListBox.ObjectCollection Items
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return null;
                return this.m_HostCheckedListBox.Items;
            }
        }
        ...
        public bool MultiColumn
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return false;
                return this.m_HostCheckedListBox.MultiColumn;
            }
        }
        ...
        public int SelectedIndex
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return -1;
                return this.m_HostCheckedListBox.SelectedIndex;
            }
            set
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return;
                this.m_HostCheckedListBox.SelectedIndex = value;
            }
        }
        ...
        public CheckedListBox.SelectedIndexCollection SelectedIndices
        {
            ...
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return null;
                return this.m_HostCheckedListBox.SelectedIndices;
            }
        }
        ...
        public object SelectedItem
        {
            ...
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return null;
                return this.m_HostCheckedListBox.SelectedItem;
            }
        }
        ...
        public SelectionMode SelectionMode
        {
            get
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return SelectionMode.One;
                return this.m_HostCheckedListBox.SelectionMode;
            }
        }
        ...
        public CheckedListBox.SelectedObjectCollection SelectedItems
        {
            ...
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return null;
                return this.m_HostCheckedListBox.SelectedItems;
            }
        }
        ...
        public int TopIndex
        {
            ...
            {
                if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return -1;
                return this.m_HostCheckedListBox.TopIndex;
            }
        }
        ...
        {
            if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return -1;
            return this.m_HostCheckedListBox.IndexFromPoint(p);
        }

        public int IndexFromPoint(int x, int y)
        {
            if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return -1;
            return this.m_HostCheckedListBox.IndexFromPoint(x, y);
        }
        #endregion

        #region ICheckedListBoxX
        public bool GetItemChecked(int iIndex)
        {
            if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return false;
            return this.m_HostCheckedListBox.GetItemChecked(iIndex);
        }

        public CheckState GetItemCheckState(int iIndex)
        {
            if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return CheckState.Unchecked;
            return this.m_HostCheckedListBox.GetItemCheckState(iIndex);
        }

        public void SetItemChecked(int iIndex, bool value)
        {
            if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return;
            this.m_HostCheckedListBox.SetItemChecked(iIndex, value);
        }

        public void SetItemCheckState(int iIndex, CheckState value)
        {
            if (this.m_HostCheckedListBox == null || this.m_HostCheckedListBox.IsDisposed) return;
            this.m_HostCheckedListBox.SetItemCheckState(iIndex, value);
        }
        #endregion
        ...
        {
            GISShare.Win32.DRAWITEMSTRUCT lParam = (GISShare.Win32.DRAWITEMSTRUCT)m.GetLParam(typeof(GISShare.Win32.DRAWITEMSTRUCT));
            IntPtr hDC = lParam.hDC;
            IntPtr handle = this.SetUpPalette(hDC, false, false);
            try
            {
                using (Graphics graphics = Graphics.FromHdcInternal(hDC))
                {
                    this.OnDrawItem
                        ...
                        new DrawItemEventArgs
                            ...
                            graphics, 
                            this.Font, 
                            Rectangle.FromLTRB(lParam.rcItem.Left, lParam.rcItem.Top, lParam.rcItem.Right, lParam.rcItem.Bottom), 
                            lParam.itemID, 
            ...
            finally
            {
                ...
                {
                    GISShare.Win32.API.SelectPalette(new System.Runtime.InteropServices.HandleRef(null, hDC), new System.Runtime.InteropServices.HandleRef(null, handle), 0);
                }
            }
            m.Result = (IntPtr)1;
        }
