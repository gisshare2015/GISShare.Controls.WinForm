...
{
    public class CheckBoxXSkinHelper : ControlSkinHelper, ICheckBoxX
    {
        ...
        private CheckBox m_HostCheckBox;

        public CheckBoxXSkinHelper(CheckBox hostCheckBox)
            : base(hostCheckBox)
        {
            ...
            //
            //
            this.m_HostCheckBox = hostCheckBox;
        }
        ...
        public bool Checked
        {
            get
            {
                if (this.m_HostCheckBox == null || this.m_HostCheckBox.IsDisposed) return false;
                return this.m_HostCheckBox.Checked;
            }
        }
        ...
        public CheckState CheckState
        {
            get
            {
                if (this.m_HostCheckBox == null || this.m_HostCheckBox.IsDisposed) return CheckState.Unchecked;
                return this.m_HostCheckBox.CheckState;
            }
        }
        #endregion
        ...
        {
            GISShare.Controls.WinForm.WinFormRenderer.WinFormRendererStrategy.OnRenderCheckBox(
