...
{
    public class RibbonBarDesigner : ControlDesigner
    {
        private RibbonBar m_RibbonBar = null;
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_RibbonBar.BaseItems)
                {
                    one.Dispose();
                }
                this.m_RibbonBar.BaseItems.Clear();
            }
        ...
        private bool SelectCompnentMouseUp(Point point)
        {
            foreach (BaseItem one in this.m_RibbonBar.BaseItems)
            {
                ...
                if (one.DesignMouseClickRectangleContainsEx(point))
                {
                    ...
                    {
                        this.m_Item2 = one;
                        if (this.m_RibbonBar.BaseItems.ExchangeItem(this.m_Item1, this.m_Item2))
                        {
        ...
        //        this.m_RibbonBar.BaseItems.Add(baseItem);
        //    }
        ...
        //        baseItem.Name = baseItem.Site.Name;
        //        baseItem.Text = baseItem.Name;
        //        switch (this.m_RibbonBar.eOrientation)
        //        {
        //            case Orientation.Vertical:
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_RibbonBar);
