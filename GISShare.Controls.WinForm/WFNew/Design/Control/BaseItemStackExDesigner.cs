...
{
    public class BaseItemStackExDesigner : ControlDesigner
    {
        private BaseItemStackEx m_BaseItemStackEx = null;

        public override void Initialize(IComponent component)
        {
            base.Initialize(component);
            //
            this.m_BaseItemStackEx = base.Component as BaseItemStackEx;
            if (this.m_BaseItemStackEx == null)
            {
                this.DisplayError(new ArgumentException("BaseItemStackEx == null"));
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_BaseItemStackEx.BaseItems)
                {
                    one.Dispose();
                }
                this.m_BaseItemStackEx.BaseItems.Clear();
            }
            ...
            foreach (BaseItem one in this.m_BaseItemStackEx.BaseItems)
            {
                ...
                if (one.DesignMouseClickRectangleContainsEx(point))
                {
                    ...
                    if (pSelectionService != null)
                    {
                        ...
                        this.m_BaseItemStackEx.Refresh();
                        return true;
                    }
                }
            }
            //
            //switch (this.m_BaseItemStackEx.eOrientation) 
            //{
            //    case Orientation.Horizontal:
            //        if (this.m_BaseItemStackEx.LeftButtonVisible && 
            //            this.m_BaseItemStackEx.LeftButtonRectangle.Contains(point)) this.m_BaseItemStackEx.TopViewItemIndex++;
            //        if (this.m_BaseItemStackEx.RightButtonVisible &&
            //            this.m_BaseItemStackEx.RightButtonRectangle.Contains(point)) this.m_BaseItemStackEx.TopViewItemIndex--;
            //        break;
            //    case Orientation.Vertical:
            //        if (this.m_BaseItemStackEx.TopButtonVisible &&
            //            this.m_BaseItemStackEx.TopButtonRectangle.Contains(point)) this.m_BaseItemStackEx.TopViewItemIndex++;
            //        if (this.m_BaseItemStackEx.BottomButtonVisible &&
            //            this.m_BaseItemStackEx.BottomButtonRectangle.Contains(point)) this.m_BaseItemStackEx.TopViewItemIndex--;
            //        break;
            //}
            if (this.m_BaseItemStackEx.PreButtonVisible &&
                this.m_BaseItemStackEx.PreButtonRectangle.Contains(point))
            {
                if (this.m_BaseItemStackEx.PreButtonIncreaseIndex) this.m_BaseItemStackEx.TopViewItemIndex++;
                else this.m_BaseItemStackEx.TopViewItemIndex--;
            }
            if (this.m_BaseItemStackEx.NextButtonVisible &&
                this.m_BaseItemStackEx.NextButtonRectangle.Contains(point))
            {
                if (this.m_BaseItemStackEx.PreButtonIncreaseIndex) this.m_BaseItemStackEx.TopViewItemIndex--;
                else this.m_BaseItemStackEx.TopViewItemIndex++;
            }
        ...
        private bool SelectCompnentMouseUp(Point point)
        {
            foreach (BaseItem one in this.m_BaseItemStackEx.BaseItems)
            {
                ...
                if (one.DesignMouseClickRectangleContainsEx(point))
                {
                    ...
                    {
                        this.m_Item2 = one;
                        if (this.m_BaseItemStackEx.BaseItems.ExchangeItem(this.m_Item1, this.m_Item2))
                        {
        ...
        //        this.m_BaseItemStackEx.BaseItems.Add(baseItem);
        //    }
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_BaseItemStackEx);
