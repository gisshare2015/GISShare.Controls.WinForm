...
namespace GISShare.Controls.WinForm.WFNew.Design
{
    ...
    {
        private ButtonN m_Button = null;

        public override void Initialize(IComponent component)
        {
            base.Initialize(component);
            //
            this.m_Button = base.Component as ButtonN;
            if (this.m_Button == null)
            {
                this.DisplayError(new ArgumentException("Button == null"));
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_Button.BaseItems)
                {
                    one.Dispose();
                }
                this.m_Button.BaseItems.Clear();
            }
        ...
        //        this.m_Button.BaseItems.Add(baseItem);
        //    }
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_Button);
