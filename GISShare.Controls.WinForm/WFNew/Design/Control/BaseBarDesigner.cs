...
{
    public class BaseBarDesigner : ControlDesigner
    {
        private BaseBar m_BaseBar = null;

        public override void Initialize(IComponent component)
        {
            base.Initialize(component);
            //
            this.m_BaseBar = base.Component as BaseBar;
            if (this.m_BaseBar == null)
            {
                this.DisplayError(new ArgumentException("BaseBar == null"));
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_BaseBar.BaseItems)
                {
                    one.Dispose();
                }
                this.m_BaseBar.BaseItems.Clear();
            }
        ...
        private bool SelectCompnentMouseUp(Point point)
        {
            foreach (BaseItem one in this.m_BaseBar.BaseItems)
            {
                ...
                if (one.DesignMouseClickRectangleContainsEx(point))
                {
                    ...
                    {
                        this.m_Item2 = one;
                        if (this.m_BaseBar.BaseItems.ExchangeItem(this.m_Item1, this.m_Item2))
                        {
        ...
        //        this.m_BaseBar.BaseItems.Add(baseItem);
        //    }
        ...
        //        baseItem.Name = baseItem.Site.Name;
        //        baseItem.Text = baseItem.Name;
        //        switch (this.m_BaseBar.eOrientation)
        //        {
        //            case Orientation.Vertical:
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_BaseBar);
