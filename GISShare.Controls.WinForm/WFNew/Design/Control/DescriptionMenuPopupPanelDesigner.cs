...
{
    public class DescriptionMenuPopupPanelDesigner : ControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            //
            this.m_DescriptionMenuPopupPanel = base.Component as DescriptionMenuPopupPanel;
            if (this.m_DescriptionMenuPopupPanel == null)
            {
                this.DisplayError(new ArgumentException("DescriptionMenuPopupPanel == null"));
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                this.m_DescriptionMenuPopupPanel.BaseItems.Clear();
            }
        ...
        private bool SelectCompnentMouseDown(Point point)
        {
            ...
            //
            if (this.m_DescriptionMenuPopupPanel.PreButtonVisible &&
                this.m_DescriptionMenuPopupPanel.PreButtonRectangle.Contains(point))
            {
                if (this.m_DescriptionMenuPopupPanel.PreButtonIncreaseIndex) this.m_DescriptionMenuPopupPanel.TopViewItemIndex++;
                else this.m_DescriptionMenuPopupPanel.TopViewItemIndex--;
            }
            if (this.m_DescriptionMenuPopupPanel.NextButtonVisible &&
                this.m_DescriptionMenuPopupPanel.NextButtonRectangle.Contains(point))
            {
                if (this.m_DescriptionMenuPopupPanel.PreButtonIncreaseIndex) this.m_DescriptionMenuPopupPanel.TopViewItemIndex--;
                else this.m_DescriptionMenuPopupPanel.TopViewItemIndex++;
            }
        ...
        private bool SelectCompnentMouseUp(Point point)
        {
            foreach (BaseItem one in this.m_DescriptionMenuPopupPanel.BaseItems)
            {
                ...
                if (one.DesignMouseClickRectangleContainsEx(point))
                {
                    ...
                    {
                        this.m_Item2 = one;
                        if (this.m_DescriptionMenuPopupPanel.BaseItems.ExchangeItem(this.m_Item1, this.m_Item2))
                        {
        ...
        //        this.m_DescriptionMenuPopupPanel.BaseItems.Add(baseItem);
        //    }
        ...
        //        baseItem.Name = baseItem.Site.Name;
        //        baseItem.Text = baseItem.Name;
        //        switch (this.m_DescriptionMenuPopupPanel.eOrientation)
        //        {
        //            case Orientation.Vertical:
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_DescriptionMenuPopupPanel);
