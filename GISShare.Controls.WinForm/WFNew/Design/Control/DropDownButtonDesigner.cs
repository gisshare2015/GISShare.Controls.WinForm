...
{
    public class DropDownButtonDesigner : ControlDesigner
    {
        ...
        public override void Initialize(IComponent component)
        {
            ...
            //
            this.m_DropDownButton = base.Component as DropDownButton;
            if (this.m_DropDownButton == null)
            {
                this.DisplayError(new ArgumentException("DropDownButton == null"));
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_DropDownButton.BaseItems)
                {
                    one.Dispose();
                }
                this.m_DropDownButton.BaseItems.Clear();
            }
        ...
        //        this.m_DropDownButton.BaseItems.Add(baseItem);
        //    }
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_DropDownButton);
        ...
        {
            this.m_DropDownButton.ShowPopup();
        }

        private void ClosePopup(object sender, EventArgs ea)
        {
            this.m_DropDownButton.ClosePopup();
        }
