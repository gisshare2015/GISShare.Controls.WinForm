...
{
    public class DropDownButtonItemDesigner : ComponentDesigner
    {
        private DropDownButtonItem m_DropDownButtonItem = null;
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_DropDownButtonItem.BaseItems)
                {
                    one.Dispose();
                }
                this.m_DropDownButtonItem.BaseItems.Clear();
            }
        ...
        //        this.m_DropDownButtonItem.BaseItems.Add(baseItem);
        //    }
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_DropDownButtonItem);
        ...
        {
            this.m_DropDownButtonItem.ShowPopup();
        }

        private void ClosePopup(object sender, EventArgs ea)
        {
            this.m_DropDownButtonItem.ClosePopup();
        }
