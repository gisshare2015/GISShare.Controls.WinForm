...
{
    public class BaseBarItemDesigner : ComponentDesigner
    {
        private BaseBarItem m_BaseBarItem = null;

        public override void Initialize(IComponent component)
        {
            base.Initialize(component);
            //
            this.m_BaseBarItem = base.Component as BaseBarItem;
            if (this.m_BaseBarItem == null)
            {
                GISShare.Controls.WinForm.WFNew.Forms.TBMessageBox.Show("BaseBarItem == null");
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_BaseBarItem.BaseItems)
                {
                    one.Dispose();
                }
                this.m_BaseBarItem.BaseItems.Clear();
            }
        ...
        //        this.m_BaseBarItem.BaseItems.Add(baseItem);
        //    }
        ...
        //        baseItem.Name = baseItem.Site.Name;
        //        baseItem.Text = baseItem.Name;
        //        switch (this.m_BaseBarItem.eOrientation)
        //        {
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_BaseBarItem);
