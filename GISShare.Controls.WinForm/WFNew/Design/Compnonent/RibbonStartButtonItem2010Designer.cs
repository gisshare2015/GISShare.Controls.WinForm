...
{
    public class RibbonStartButtonItem2010Designer : ComponentDesigner
    {
        private RibbonStartButtonItem2010 m_RibbonStartButtonItem2010 = null;

        public override void Initialize(IComponent component)
        {
            base.Initialize(component);
            //
            this.m_RibbonStartButtonItem2010 = base.Component as RibbonStartButtonItem2010;
            if (this.m_RibbonStartButtonItem2010 == null)
            {
                GISShare.Controls.WinForm.WFNew.Forms.TBMessageBox.Show("RibbonStartButtonItem2010 == null");
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_RibbonStartButtonItem2010.MenuItems)
                {
                    one.Dispose();
                }
                this.m_RibbonStartButtonItem2010.MenuItems.Clear();
                //
                foreach (BaseItem one in this.m_RibbonStartButtonItem2010.RecordItems)
                {
                    one.Dispose();
                }
                this.m_RibbonStartButtonItem2010.RecordItems.Clear();
                //
                foreach (BaseItem one in this.m_RibbonStartButtonItem2010.OperationItems)
                {
                    one.Dispose();
                }
                this.m_RibbonStartButtonItem2010.OperationItems.Clear();
            }
        ...
        //        this.m_RibbonStartButtonItem2010.MenuItems.Add(baseItem);
        //    }
        //}
        ...
        //        baseItem.Text = baseItem.Name;
        //        baseItem.Size = new Size(60, 21);
        //        this.m_RibbonStartButtonItem2010.RecordItems.Add(baseItem);
        //    }
        //}
        ...
        //        baseItem.TextAlign = ContentAlignment.MiddleLeft;
        //        baseItem.Size = new Size(60, 21);
        //        this.m_RibbonStartButtonItem2010.OperationItems.Add(baseItem);
        //    }
        //}
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_RibbonStartButtonItem2010);
        ...
        {
            this.m_RibbonStartButtonItem2010.ShowPopup();
        }

        private void CloseApplicationPopup(object sender, EventArgs ea)
        {
            this.m_RibbonStartButtonItem2010.ClosePopup();
        }
    }
}
