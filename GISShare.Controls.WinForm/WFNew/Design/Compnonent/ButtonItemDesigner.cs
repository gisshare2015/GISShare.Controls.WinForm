...
{
    public class ButtonItemDesigner : ComponentDesigner
    {
        private ButtonItem m_ButtonItem = null;

        public override void Initialize(IComponent component)
        {
            base.Initialize(component);
            //
            this.m_ButtonItem = base.Component as ButtonItem;
            if (this.m_ButtonItem == null)
            {
                GISShare.Controls.WinForm.WFNew.Forms.TBMessageBox.Show("ButtonItem == null");
                return;
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                foreach (BaseItem one in this.m_ButtonItem.BaseItems)
                {
                    one.Dispose();
                }
                this.m_ButtonItem.BaseItems.Clear();
            }
        ...
        //        this.m_ButtonItem.BaseItems.Add(baseItem);
        //    }
        ...
        private void BuildTreeView(object sender, EventArgs ea)
        {
            ...
            BaseItemCollectionDesignerFormEx baseItemCollectionDesignerFormEx = new BaseItemCollectionDesignerFormEx(this.m_ButtonItem);
        ...
        {
            this.m_ButtonItem.ShowPopup();
        }

        private void ClosePopup(object sender, EventArgs ea)
        {
            this.m_ButtonItem.ClosePopup();
        }
