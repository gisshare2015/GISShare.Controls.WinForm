...
{
    [ToolboxItem(false), DefaultEvent("Click"), Category("GISShare.Controls.WinForm.WFNew")]
    public abstract class BaseItemControl : System.Windows.Forms.Control, 
        ...
        IEventHelper, IObjectDesignHelper
    {
        ...
        void IOwner.Refresh()
        {
            //Console.WriteLine("void IOwner.Refresh()");
        ...
        {
            if (this.AutoGetFocus && !this.Focused)
            {
                this.Focus();
            }
            //
