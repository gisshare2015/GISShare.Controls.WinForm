...
{
    [ToolboxItem(false)]
    public class CustomizeComboBox : BaseItemControl, ICustomizeComboBoxItem, ICustomizeComboBoxItemEvent, IInputObject, IInputObjectHelper, IPopupOwnerHelper
    {
        ...
        public CustomizeComboBox(Control ctr)
        ...
        //public void ddd()
        //{
        //    GISShare.Controls.WinForm.WFNew.BaseButtonN btnOK = new BaseButtonN();
        //    btnOK.Name = "OK";
        //    btnOK.Text = "确定";
        //    btnOK.Dock = DockStyle.Bottom;
        //    btnOK.Size = new System.Drawing.Size(21, 21);
        //    btnOK.Click += new EventHandler(btnOK_Click);
        //    this.m_pCustomizePopup.ControlObject.Controls.Add(btnOK);
        //    this.m_pCustomizePopup.ControlObject.Controls.SetChildIndex(btnOK, this.m_pCustomizePopup.ControlObject.Controls.Count - 1);
        //}
        ...
        {
            CustomizeComboBox baseItem = new CustomizeComboBox(this.m_pCustomizePopup);
        ...
        protected override void OnMouseMove(MouseEventArgs mevent)
        {
            if (this.SplitRectangle.Contains(mevent.Location))
            {
                if (this.eSplitState != BaseItemState.ePressed &&
                    this.eSplitState != BaseItemState.eHot) { this.m_eSplitState = BaseItemState.eHot; this.Invalidate(this.SplitRectangle); }
                this.OnSplitMouseMove(mevent);
            }
            else
            {
                if (this.eSplitState != BaseItemState.ePressed &&
                    this.eSplitState != BaseItemState.eNormal) { this.m_eSplitState = BaseItemState.eNormal; this.Invalidate(this.SplitRectangle); }
