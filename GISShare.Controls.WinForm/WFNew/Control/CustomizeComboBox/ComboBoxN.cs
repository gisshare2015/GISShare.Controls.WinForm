...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class ComboBoxN : CustomizeComboBox, IComboBoxItem
    {
        ...
        {
            get { return this.m_ViewItemListBox.SelectedItem; }
        }
        #endregion
        ...
        {
            ComboBoxN baseItem = new ComboBoxN();
        ...
        void baseItem_SelectedIndexChanged(object sender, IntValueChangedEventArgs e)
        {
