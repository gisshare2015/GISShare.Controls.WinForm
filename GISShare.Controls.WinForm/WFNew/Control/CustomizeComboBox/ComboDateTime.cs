...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class ComboDateTime : CustomizeComboBox, IComboDateTimeItem
    {
        TimeMonthCalendarCombineControl m_TimeMonthCalendarCombineControl;

        public ComboDateTime()
            : base(new TimeMonthCalendarCombineControl())
        {
            base.AutoClosePopup = false;
            //
            this.m_TimeMonthCalendarCombineControl = ((ICustomizeComboBoxItem)this).ControlObject as TimeMonthCalendarCombineControl;
            this.m_TimeMonthCalendarCombineControl.BackColor = System.Drawing.SystemColors.Window;
            this.m_TimeMonthCalendarCombineControl.Dock = System.Windows.Forms.DockStyle.Fill;
            this.m_TimeMonthCalendarCombineControl.SelectedDateTimeChanged += new PropertyChangedEventHandler(TimeMonthCalendarCombineControl_SelectedDateTimeChanged);
            //
            this.ShowDropDownNum = 1;
            base.DropDownWidth = 222;
        }
        void TimeMonthCalendarCombineControl_SelectedDateTimeChanged(object sender, PropertyChangedEventArgs e)
        {
            this.OnSelectedDateTimeChanged(new PropertyChangedEventArgs(typeof(DateTime), e.OldValue, e.NewValue));
            //
        ...
        protected override EventStateStyle GetEventStateSupplement(string strEventName)
        {
            switch (strEventName)
            {
                case "SelectedDateTimeChanged":
                    return this.SelectedDateTimeChanged != null ? EventStateStyle.eUsed : EventStateStyle.eUnused;
                default:
                    break;
            }
            //
        ...
        protected override bool RelationEventSupplement(string strEventName, EventArgs e)
        {
            ...
            {
                case "SelectedDateTimeChanged":
                    if (this.SelectedDateTimeChanged != null) { this.SelectedDateTimeChanged(this, e as PropertyChangedEventArgs); }
                    return true;
                default:
                    break;
            }
        ...
        public DateTime SelectedDateTime
        {
            get
            {
                return this.m_TimeMonthCalendarCombineControl.DateTime;
            }
            set
            {
                this.m_TimeMonthCalendarCombineControl.DateTime = value;
            }
        }
        #endregion
        ...
        {
            ComboDateTime baseItem = new ComboDateTime();
            ...
            //IComboDateItem
            baseItem.SelectedDateTime = this.SelectedDateTime;
            ...
            if (this.GetEventState("SelectedDateTimeChanged") == EventStateStyle.eUsed) baseItem.SelectedDateTimeChanged += new PropertyChangedEventHandler(baseItem_SelectedDateTimeChanged);
            return baseItem;
        }
        ...
        void baseItem_SelectedDateTimeChanged(object sender, PropertyChangedEventArgs e)
        {
            this.RelationEvent("SelectedDateTimeChanged", e);
        }
        #endregion
        ...
        public override string Text
        {
            get
            {
                return this.m_TimeMonthCalendarCombineControl.DateTime.ToString("yyyy-MM-dd HH:mm:ss");
            }
            set
            {
                DateTime dtDate;
                ...
                {
                    this.m_TimeMonthCalendarCombineControl.DateTime = dtDate;
                }
            }
        }
