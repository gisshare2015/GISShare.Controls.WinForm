...
{
    [Designer(typeof(GISShare.Controls.WinForm.WFNew.Design.ButtonGroupDesigner)), ToolboxItem(true)]
    public class ButtonGroup : BaseItemStack, IButtonGroupItem
    {
        public ButtonGroup() 
            : base()
        {
        ...
        {
            ButtonGroup baseItem = new ButtonGroup();
