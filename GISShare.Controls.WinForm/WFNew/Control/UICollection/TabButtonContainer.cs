...
{
    [ToolboxItem(false)]
    public class TabButtonContainer : BaseItemStack, IBaseItemStackExItem, IBaseItemStackExItemEvent, ITabButtonContainerItem, ITabButtonContainerItemEvent, IGetPartItemHelper
    {
        ...
        public bool AutoVisible
        {
            ...
            set 
            {
                ...
                if (this.AutoVisible)
                {
                    if (this.BaseItems.Count > 1) { this.Visible = true; }
        ...
        public TabButtonContainerStyle eTabButtonContainerStyle
        {
        ...
        protected override Size Relayout(Graphics g, LayoutStyle eLayoutStyle, bool bSetSize)
        {
            ...
            if (this.eTabButtonContainerStyle == TabButtonContainerStyle.eContextButtonAndCloseButton)
            {
