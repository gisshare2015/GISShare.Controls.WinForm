...
{
    public class RibbonQuickAccessToolbar : BaseBar, IQuickAccessToolbarItem
    {
        ...
        public QuickAccessToolbarStyle eQuickAccessToolbarStyle
        {
            ...
            set { m_eQuickAccessToolbarStyle = value; }
        }
        ...
        {
            RibbonQuickAccessToolbar baseItem = new RibbonQuickAccessToolbar();
