...
{
    [Designer(typeof(GISShare.Controls.WinForm.WFNew.Design.RibbonGalleryRowDesigner)), ToolboxItem(false)]
    public class RibbonGalleryRow : BaseItemStack
    {
        ...
        {
            RibbonGalleryRow baseItem = new RibbonGalleryRow();
