...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class BaseBar : BaseItemStack, IBaseBarItem, IGetPartItemHelper
    {
        ...
        [Browsable(true), DefaultValue(true), Description("是否显示溢出按钮"), Category("布局")]
