...
{
    [Designer(typeof(GISShare.Controls.WinForm.WFNew.Design.RibbonBarDesigner)), ToolboxItem(true)]
    public class RibbonBar : BaseItemStack, IRibbonBarItem, IRibbonBarItemEvent, ISetRibbonBarHelper, IPopupOwner, IPopupOwnerHelper
    {
        ...
        {
            RibbonBar baseItem = new RibbonBar();
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (this.IsMinState)
            {
                if (this.PopupTriggerRectangle.Contains(e.Location))//if (this.DrawRectangle.Contains(e.Location))
                {
                    this.ShowPopup();
                    return;
                }
        ...
        protected override void OnDraw(PaintEventArgs e)
        {
            ...
            else
            {
                ...
                //
                rectangleText =
                    new Rectangle(rectangle.X + (rectangle.Width - iWidth) / 2, rectangle.Y, iWidth, rectangle.Height - 1);
                //
