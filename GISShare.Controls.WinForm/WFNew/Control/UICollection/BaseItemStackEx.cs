...
{
    [Designer(typeof(GISShare.Controls.WinForm.WFNew.Design.BaseItemStackExDesigner)), DefaultEvent("TopViewItemIndexChanged"), ToolboxItem(true)]
    public class BaseItemStackEx : BaseItemStack, IBaseItemStackExItem, IBaseItemStackExItemEvent
    {
        ...
        public PNLayoutStyle ePNLayoutStyle
        {
        ...
        protected override Size Relayout(Graphics g, LayoutStyle eLayoutStyle, bool bSetSize)
        {
            ...
            if (!size.IsEmpty)
            {
                ...
                {
                    //System.Diagnostics.Debug.WriteLine(this.BaseItems.GetItemCount(true) + ":" + this.Size.ToString() + " - " + size.ToString());
