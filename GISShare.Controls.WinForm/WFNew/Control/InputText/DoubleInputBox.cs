...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class DoubleInputBox : BaseItemControl, IDoubleInputBoxItem, IDoubleInputBoxItemEvent, IUpDownButtonObjectHelper, IInputObject, IInputObject2, IInputObjectHelper
    {
        ...
        string IInputObject.InputText
        {
            ...
            set
            {
                ...
                //
                double iOld = this.Value;
                this.m_InputText = value;
                this.OnValueChanged(new DoubleValueChangedEventArgs(iOld, this.Value));
            }
        }
        ...
        {
            DoubleInputBox baseItem = new DoubleInputBox();
