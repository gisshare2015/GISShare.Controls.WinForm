...
{
    [DefaultEvent("TextChanged"), ToolboxItem(true)]
    public class TextBoxN : BaseItemControl, ITextBoxItem, ITextBoxItem2, IInputObject, IInputObjectHelper
    {
        ...
        {
            TextBoxN baseItem = new TextBoxN();
            ...
            get
            {
                ...
                switch (this.eBorderStyle)
                {
                    case BorderStyle.eNone:
                        return new Rectangle
                            (
                            this.PointToScreen(rectangle.Location), new Size(rectangle.Width, iH)
                            );
                    case BorderStyle.eSingle:
                    default:
                        return new Rectangle
                            ...
                            new Size(rectangle.Width - 2 * CTR_BORDERSPASE, iH)
                            );
                }
            }
        }
