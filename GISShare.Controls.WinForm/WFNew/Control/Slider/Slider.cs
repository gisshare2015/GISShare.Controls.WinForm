...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class Slider : BaseItemControl, IMessagePermeate,
        ICollectionItem, ICollectionItem2, ICollectionItem3, IUICollectionItem, ISliderItem, ISliderItemEvent
    {
        ...
        {
            get { return this.Value/ (this.Maximum - this.Minimum); }
        }
