...
{
    [Designer(typeof(GISShare.Controls.WinForm.WFNew.Design.RibbonStartButton2007Designer)), ToolboxItem(true)]
    public class RibbonStartButton2007 : GISShare.Controls.WinForm.WFNew.BaseButtonN, IStartButtonItem, IPopupOwnerHelper, ICollectionObjectDesignHelper, IPopupObjectDesignHelper
    {
        private IApplicationPopup m_RibbonApplicationPopup;

        public RibbonStartButton2007(IApplicationPopup pApplicationPopup)
            : base()
        {
        ...
        {
            RibbonStartButton2007 baseItem = new RibbonStartButton2007();
