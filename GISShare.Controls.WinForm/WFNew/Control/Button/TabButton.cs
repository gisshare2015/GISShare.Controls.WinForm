...
{
    [ToolboxItem(false)]
    public class TabButton : BaseButtonEx, ITabButtonItem, ITabButtonItemEvent, ISetTabButtonItemHelper
    {
        ...
        {
            get { return this.pOwner is ICollectionItem; }
        }
        ...
        {
            if (bIsSelected == this.IsSelected) return;
            //
        ...
        {
            TabButton baseItem = new TabButton();
        ...
        protected override void OnMouseUp(MouseEventArgs mevent)
        {
            if (this.ShowCloseButton)
            {
                ...
                {
                    if (this.CloseButtonRectangle.Contains(mevent.Location)) { this.m_eCloseButtonState = BaseItemState.eHot; }
