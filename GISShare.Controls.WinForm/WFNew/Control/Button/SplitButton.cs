...
{
    [ToolboxItem(true)]
    public class SplitButton : DropDownButton, ISplitButtonItem, ISplitButtonItemEvent
    {
        ...
        {
            SplitButton baseItem = new SplitButton();
        ...
        protected override void OnMouseDown(MouseEventArgs mevent)
        {
            ...
            {
                this.m_eSplitState = BaseItemState.ePressed; this.OnSplitMouseDown(mevent);
            }
            else
            {
