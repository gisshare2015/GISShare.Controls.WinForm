...
{
    [Designer(typeof(GISShare.Controls.WinForm.WFNew.Design.DropDownButtonDesigner)), ToolboxItem(true)]
    public class DropDownButton : GISShare.Controls.WinForm.WFNew.BaseButtonN, IDropDownButtonItem, IPopupOwnerHelper, ICollectionObjectDesignHelper, IPopupObjectDesignHelper//, IBaseItemOwner, IBaseItemOwner2
    {
        //private const int CTR_SPACE = 4;
        ...
        public DropDownButton(ISimplyPopup pSimplyPopup)
            : base()
        {
        ...
        public override Rectangle ButtonRectangle
        {
            get
            {
                Rectangle rectangle = base.DisplayRectangle;
                ...
                {
                    case ArrowDock.eUp:
                        return new Rectangle(rectangle.X, rectangle.Y + this.DropDownDistance, rectangle.Width - 1, rectangle.Height - this.DropDownDistance);
                    case ArrowDock.eDown:
        ...
        {
            DropDownButton baseItem = new DropDownButton();
