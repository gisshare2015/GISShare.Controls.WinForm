...
{
    [ToolboxItem(true)]
    public class ImageZoomableBox : AreaControl, IImageZoomableBoxItem
    {
        const float CONST_MINWidth = 30;
        const float CONST_MINHeight = 30;

        public ImageZoomableBox()
        {
        ...
        public Image Image
        {
            ...
            set
            {
                ...
                if (this.Image != null) this.Invalidate();
            }
        }
        ...
        public void FullExtent(bool bRefresh)
        {
            ...
            else
            {
                ...
                Rectangle displayRectangle = this.DisplayRectangle;
                if (this.ShowOutLine) displayRectangle = Rectangle.FromLTRB(displayRectangle.Left + 1, displayRectangle.Top + 1, displayRectangle.Right - 1, displayRectangle.Bottom - 1);
                this.m_ImageRectangle = GISShare.Controls.WinForm.Util.UtilTX.CreateRectangle(displayRectangle, (double)size.Width, (double)size.Height);
                if (bRefresh) this.Invalidate();
            }
        }
        #endregion
        ...
        {
            ImageZoomableBox baseItem = new ImageZoomableBox();
