...
{
    public class VRowColumnTitleViewItem : TitleViewItem, 
        IRowViewItem,
        ...
        IViewItemOwner, IViewItemOwner2, IViewList
    {
        ...
        public VRowColumnTitleViewItem()
            : base()
        {
            this.m_ViewItemCollection = new TitleViewItemCollection(this);
        }

        public VRowColumnTitleViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public VRowColumnTitleViewItem(string name, string text)
            : this()
        {
            this.Name = name;
            this.Text = text;
        ...
        public VRowColumnTitleViewItem(string name, string text, Font font)
            : this()
        {
            this.Name = name;
            this.Text = text;
            ...
            set
            {
                ...
                if (this.IsFilled)
                {
                    ...
                    if (iCount > 0)
                    {
                        ...
                        foreach (TitleViewItem one in this.ViewItems)
                        {
                            if (one.Visible) { one.Height += iYS; break; }
                        }
                    }
                }
            }
