...
{
    public class CellViewItemCollection : FlexibleList<CellViewItem>
    {
        private IOwner m_Owner = null;
        private List<CellViewItem> innerList = null;

        internal CellViewItemCollection(IOwner pOwner)
        {
            this.m_Owner = pOwner;
            this.innerList = new List<CellViewItem>();
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual bool Filtration(CellViewItem value)
        {
        ...
        protected virtual bool SetItemAttribute(CellViewItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        protected void SetItemAttribute2(CellViewItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        protected virtual bool RestoreItemAttribute(CellViewItem value)
        {
        ...
        public override int Add(CellViewItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        public void Add2(CellViewItem value)
        {
        ...
        public override void Insert(int index, CellViewItem value)
        {
            if (this.Locked) return;
            //
        ...
        public override bool Contains(CellViewItem value)
        {
        ...
        public override int IndexOf(CellViewItem value)
        {
            if (value == null) return -1;
            //
        ...
        public override void Remove(CellViewItem value)
        {
            if (this.Locked) return;
            //
            if (value == null) return;
        ...
        public override void RemoveAt(int index)
        {
            if (this.Locked) return;
            //
            CellViewItem baseItem = this.innerList[index];
        ...
        public override CellViewItem this[int index]
        {
            get
            {
        ...
        public CellViewItem this[string strName]
        {
            get
            {
                foreach (CellViewItem one in this.innerList)
                {
        ...
        public override bool ExchangeItemT(CellViewItem item1, CellViewItem item2)
        {
        ...
        private void RefreshOwner(int index, CellViewItem value)
        {
