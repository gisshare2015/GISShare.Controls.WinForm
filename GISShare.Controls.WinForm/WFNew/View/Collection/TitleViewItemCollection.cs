...
{
    public class TitleViewItemCollection : FlexibleList<TitleViewItem>
    {
        private IOwner m_Owner = null;
        private List<TitleViewItem> innerList = null;

        internal TitleViewItemCollection(IOwner pOwner)
        {
            this.m_Owner = pOwner;
            this.innerList = new List<TitleViewItem>();
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual bool Filtration(TitleViewItem value)
        {
        ...
        protected virtual bool SetItemAttribute(TitleViewItem value)
        {
        ...
        /// </summary>
        /// <param name="value"></param>
        protected virtual bool RestoreItemAttribute(TitleViewItem value)
        {
        ...
        public override int Add(TitleViewItem value)
        {
        ...
        public override void Insert(int index, TitleViewItem value)
        {
        ...
        public override bool Contains(TitleViewItem value)
        {
        ...
        public override int IndexOf(TitleViewItem value)
        {
            if (value == null) return -1;
            //
        ...
        public override void Remove(TitleViewItem value)
        {
            if (this.Locked) return;
            //
            if (value == null) return;
        ...
        public override void RemoveAt(int index)
        {
            if (this.Locked) return;
            //
            TitleViewItem baseItem = this.innerList[index];
        ...
        public override TitleViewItem this[int index]
        {
            get
            {
        ...
        public override bool ExchangeItemT(TitleViewItem item1, TitleViewItem item2)
        {
        ...
        private void RefreshOwner(int index, TitleViewItem value)
        {
