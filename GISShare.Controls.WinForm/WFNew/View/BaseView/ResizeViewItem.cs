...
{
    public class ResizeViewItem : TextViewItem, IResizeViewItem
    {
        ...
        public ResizeViewItem() { }

        public ResizeViewItem(string text)
            : base(text) { }

        public ResizeViewItem(string name, string text)
            : base(name, text) { }

        public ResizeViewItem(string name, string text, Font font)
            : base(name, text, font) { }
