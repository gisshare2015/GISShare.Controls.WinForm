...
{
    public class FlexibleRowViewItem : TextEditViewItem, 
        IRowViewItem, 
        ...
        IViewItemOwner, IViewItemOwner2, IViewList
    {
        ...
        public FlexibleRowViewItem()
        {
            this.m_ViewItemCollection = new SizeViewItemCollection(this);
        }

        public FlexibleRowViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public FlexibleRowViewItem(string name, string text)
            : this()
        {
            this.Name = name;
            this.Text = text;
        ...
        public FlexibleRowViewItem(string name, string text, Font font)
            : this()
        {
            this.Name = name;
            this.Text = text;
        ...
        public override int Width
        {
            ...
            set
            {
                ...
                if (this.IsFilled)
                {
                    ...
                    {
                        int iZL = iW / this.ViewItems.Count;
                        int iYS = iW % this.ViewItems.Count;
                        foreach (SizeViewItem one in this.ViewItems)
                        {
                            one.Width += iZL;
                        }
                        this.ViewItems[0].Width += iYS;
                    }
                }
            }
        }
