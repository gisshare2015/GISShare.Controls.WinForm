...
{
    public class RowViewItem : TextEditViewItem, 
        IRowViewItem, 
        IViewListEnumerator,
        ...
        IViewItemOwner, IViewItemOwner2, IViewList
    {
        ...
        public RowViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public RowViewItem(string name, string text)
            : this()
        {
            this.Name = name;
            this.Text = text;
        ...
        public RowViewItem(string name, string text, Font font)
            : this()
        {
            this.Name = name;
            this.Text = text;
        ...
        public override Size MeasureSize(Graphics g)
        {
            if (this.ViewItems.Count > 0)
            {
                ...
                return new Size(iW, this.Height > iH ? this.Height : iH);
            }
            //
