...
{
    public class FlexibleRowNodeViewItem : NodeViewItem, IRowViewItem, IFlexibleRowViewItem
    {
        FlexibleRowViewItem m_pRowViewItem;

        public FlexibleRowNodeViewItem()
            : base()
        {
        ...
        public FlexibleRowNodeViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public FlexibleRowNodeViewItem(string name, string text)
            : this()
        {
            this.Name = name; 
            this.Text = text;
