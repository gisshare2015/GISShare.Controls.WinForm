...
{
    public class VRowNodeViewItem : NodeViewItem, IRowViewItem
    {
        VRowViewItem m_pRowViewItem;

        public VRowNodeViewItem()
            : base()
        {
        ...
        public VRowNodeViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public VRowNodeViewItem(string name, string text)
            : this()
        {
            this.Name = name; 
            this.Text = text;
