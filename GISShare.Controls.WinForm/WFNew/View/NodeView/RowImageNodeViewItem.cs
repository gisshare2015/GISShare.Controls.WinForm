...
{
    public class RowImageNodeViewItem : ImageNodeViewItem, IRowViewItem
    {
        RowViewItem m_pRowViewItem;

        public RowImageNodeViewItem()
            : base()
        {
        ...
        public RowImageNodeViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public RowImageNodeViewItem(string name, string text)
            : this()
        {
            this.Name = name; 
            this.Text = text;
        ...
        public RowImageNodeViewItem(string text, Image image)
            : this()
        {
            this.Text = text;
            this.Image = image;
        ...
        public RowImageNodeViewItem(string name, string text, Image image)
            : this()
        {
            this.Name = name; 
            this.Text = text;
