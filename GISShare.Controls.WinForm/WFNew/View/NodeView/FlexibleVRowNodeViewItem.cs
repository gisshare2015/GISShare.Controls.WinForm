...
{
    public class FlexibleVRowNodeViewItem : NodeViewItem, IRowViewItem, IFlexibleRowViewItem
    {
        FlexibleVRowViewItem m_pRowViewItem;

        public FlexibleVRowNodeViewItem()
            : base()
        {
        ...
        public FlexibleVRowNodeViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public FlexibleVRowNodeViewItem(string name, string text)
            : this()
        {
            this.Name = name; 
            this.Text = text;
