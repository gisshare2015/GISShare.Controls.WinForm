...
{
    public class FlexibleRowImageNodeViewItem : ImageNodeViewItem, IRowViewItem, IFlexibleRowViewItem
    {
        FlexibleRowViewItem m_pRowViewItem;

        public FlexibleRowImageNodeViewItem()
            : base()
        {
            this.m_pRowViewItem = new FlexibleRowViewItem();
            this.m_pRowViewItem.Text = "FlexibleRowViewItem";
            this.m_pRowViewItem.ShowBaseItemState = false;
            ((ISetOwnerHelper)this.m_pRowViewItem).SetOwner(this);
        }

        public FlexibleRowImageNodeViewItem(string text)
            : this()
        {
            this.Text = text;
        }

        public FlexibleRowImageNodeViewItem(string name, string text)
            : this()
        {
            this.Name = name; 
            this.Text = text;
        ...
        public FlexibleRowImageNodeViewItem(string text, Image image)
            : this()
        {
            this.Text = text;
            this.Image = image;
        ...
        public FlexibleRowImageNodeViewItem(string name, string text, Image image)
            : this()
        {
            this.Name = name; 
            this.Text = text;
