...
{
    public class ResizeImageNodeViewItem : ImageNodeViewItem, ISizeViewItem
    {
        ...
        public ResizeImageNodeViewItem()
            : base() { }

        public ResizeImageNodeViewItem(string text)
            : base(text) { }

        public ResizeImageNodeViewItem(string text, Image image)
            : base(text, image) { }

        public ResizeImageNodeViewItem(string name, string text)
            : base(name, text) { }

        public ResizeImageNodeViewItem(string name, string text, Image image)
