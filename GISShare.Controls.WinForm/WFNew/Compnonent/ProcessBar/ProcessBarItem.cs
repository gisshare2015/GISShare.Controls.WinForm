...
{
    public class ProcessBarItem : BaseItem, IProcessBarItem, IProcessBarItemEvent
    {
        #region 构造函数
        public ProcessBarItem() { }

        //public ProcessBarItem(GISShare.Controls.Plugin.WFNew.IProcessBarItemP pBaseItemP)
        //{
        //    //IPlugin
        ...
        {
            ProcessBarItem baseItem = new ProcessBarItem();
        ...
        {
            WFNew.WFNewRenderer.WFNewRendererStrategy.OnRenderProcessBar(new ObjectRenderEventArgs(e.Graphics, this, this.FrameRectangle));//
        }
