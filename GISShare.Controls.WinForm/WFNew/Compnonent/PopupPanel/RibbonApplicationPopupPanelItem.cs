...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    /// 绘制型 应用程序清单弹出菜单面板
    /// </summary>
    [Designer(typeof(GISShare.Controls.WinForm.WFNew.Design.RibbonApplicationPopupPanelItemDesigner))]
    public class RibbonApplicationPopupPanelItem : BaseItem, 
        IRibbonApplicationPopupPanelItem,
        IUICollectionItem,
        ICollectionObjectDesignHelper
    {
        ...
        public RibbonApplicationPopupPanelItem()
        {
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                return new Rectangle
                    ...
                    this.Location,
                    new Size
                       (this.Padding.Left + this.m_RibbonApplicationPopupPanelMiddleLeft.DisplayRectangle.Width + this.MROMiddleSpace + this.m_RibbonApplicationPopupPanelMiddleRight.DisplayRectangle.Width + this.Padding.Right,
        ...
        public Point AnchorPoint { get { return this.m_RibbonApplicationPopupPanelMiddleRight.Location; } }
