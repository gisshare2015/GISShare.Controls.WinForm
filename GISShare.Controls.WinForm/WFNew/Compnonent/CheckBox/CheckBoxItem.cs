...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class CheckBoxItem : BaseItem, ICheckBoxItem
    {
        ...
        public CheckBoxItem(string strText)
        {
            this.Text = strText;
        }

        public CheckBoxItem(string strName, string strText)
        {
            this.Name = strName;
            this.Text = strText;
        }

        public CheckBoxItem(string strName, string strText, bool bChecked)
        {
            this.Name = strName;
            this.Text = strText;
        ...
        //public CheckBoxItem(GISShare.Controls.Plugin.WFNew.ICheckBoxItemP pBaseItemP)
        //{
        //    //IPlugin
        ...
        {
            CheckBoxItem baseItem = new CheckBoxItem();
