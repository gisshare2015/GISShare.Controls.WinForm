...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class IntegerInputBoxItem : BaseItem, IIntegerInputBoxItem, IIntegerInputBoxItemEvent, IUpDownButtonObjectHelper, IInputObject , IInputObject2, IInputObjectHelper
    {
        ...
        //public IntegerInputBoxItem(GISShare.Controls.Plugin.WFNew.IIntegerInputBoxItemP pBaseItemP)
        //    : this()
        //{
        //    //IPlugin
        ...
        {
            IntegerInputBoxItem baseItem = new IntegerInputBoxItem();
        ...
        protected override void OnDraw(PaintEventArgs e)
        {
            ...
            if (!this.IsInputing)
            {
                GISShare.Controls.WinForm.WFNew.WFNewRenderer.WFNewRendererStrategy.OnRenderTextBoxText(
                    new TextRenderEventArgs(e.Graphics, this, this.Enabled, this.HaveShadow, this.m_InputText, this.ForeCustomize, this.ForeColor, this.ShadowColor, this.Font, this.TextRectangle));
            }
        }
