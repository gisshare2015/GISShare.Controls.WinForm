...
namespace GISShare.Controls.WinForm.WFNew
{
    ...
    public class ScrollBarItem : BaseItem, 
        IMessagePermeate,
        IScrollBarItem, 
        ...
        IScrollBarItemEvent
    {
        ...
        private const int CONST_SLIDERBUTTONMINSIZE = 21;
        ...
        //public ScrollBarItem(GISShare.Controls.Plugin.WFNew.IScrollBarItemP pBaseItemP)
        //    : this()
        //{
        //    //IPlugin
        ...
        {
            ScrollBarItem baseItem = new ScrollBarItem();
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            base.OnMouseDown(e);
            //
            //Console.WriteLine("OnMouseDown:" + this.m_IsMouseDown);
        }

        protected override void OnMouseMove(MouseEventArgs e)
        {
            //Console.WriteLine("OnMouseMove:" + this.m_IsMouseDown);
            if (this.m_IsMouseDown)
            {
                this.Value = this.GetValueFromPoint(e.Location);
                //System.Diagnostics.Debug.WriteLine(this.ScrollButtonRectangle.ToString());
            }
            //
            base.OnMouseMove(e);
        }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            //Console.WriteLine("OnMouseUp:" + this.m_IsMouseDown);
        }
