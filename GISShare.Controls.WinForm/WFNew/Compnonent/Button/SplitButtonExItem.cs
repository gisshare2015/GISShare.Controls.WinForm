...
{
    public class SplitButtonExItem : SplitButtonItem, IBaseButtonExItem
    {
        #region 构造函数
        public SplitButtonExItem(ISimplyPopup pSimplyPopup)
            : base(pSimplyPopup) { }

        public SplitButtonExItem()
            : base(new DropDownPopup()) { }

        public SplitButtonExItem(string strText)
            : base(strText) { }

        public SplitButtonExItem(string strName, string strText)
            : base(strName, strText) { }

        public SplitButtonExItem(string strText, Image image)
            : base(strText, image) { }

        public SplitButtonExItem(string strName, string strText, Image image)
            : base(strName, strText, image) { }

        //public SplitButtonExItem(GISShare.Controls.Plugin.WFNew.ISplitButtonExItemP pBaseItemP)
        //{
        //    //IPlugin
        ...
        {
            SplitButtonExItem baseItem = new SplitButtonExItem();
