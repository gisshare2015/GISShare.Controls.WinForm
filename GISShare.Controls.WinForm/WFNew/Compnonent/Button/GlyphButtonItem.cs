...
{
    public  class GlyphButtonItem : BaseButtonItem, IGlyphButtonItem
    {
        #region 构造函数
        public GlyphButtonItem()
            : base()
        {
            this.Padding = new Padding(3);
        }

        public GlyphButtonItem(string strText)
            : base(strText) { }

        public GlyphButtonItem(string strName, string strText)
            : base(strName, strText) { }

        //public GlyphButtonItem(GISShare.Controls.Plugin.WFNew.IGlyphButtonItemP pBaseItemP)
        //{
        //    //IPlugin
        ...
        {
            GlyphButtonItem baseItem = new GlyphButtonItem();
