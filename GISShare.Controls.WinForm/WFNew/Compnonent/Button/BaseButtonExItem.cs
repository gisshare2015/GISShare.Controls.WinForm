...
{
    public class BaseButtonExItem : BaseButtonItem, IBaseButtonExItem
    {
        #region 构造函数
        public BaseButtonExItem()
            : base() { }

        public BaseButtonExItem(string strText)
            : base(strText) { }

        public BaseButtonExItem(string strName, string strText)
            : base(strName, strText) { }

        public BaseButtonExItem(string strText, Image image)
            : base(strText, image) { }

        public BaseButtonExItem(string strName, string strText, Image image)
            : base(strName, strText, image) { }

        //public BaseButtonExItem(GISShare.Controls.Plugin.WFNew.IBaseButtonExItemP pBaseItemP)
        //{
        //    //IPlugin
        ...
        {
            BaseButtonExItem baseItem = new BaseButtonExItem();
