...
{
    public class ImageAreaBoxItem : AreaItem, IImageBoxItem
    {
        #region 构造函数
        public ImageAreaBoxItem()
        {
            this.ShowOutLine = true;
        }

        public ImageAreaBoxItem(Image image)
            : this()
        {
            this.Image = image;
        }

        public ImageAreaBoxItem(string strName, Image image)
            : this()
        {
            this.Name = strName;
            this.Image = image;
        ...
        //public ImageAreaBoxItem(GISShare.Controls.Plugin.WFNew.IImageBoxItemP pBaseItemP)
        //{
        //    //IPlugin
        ...
        {
            ImageAreaBoxItem baseItem = new ImageAreaBoxItem();
