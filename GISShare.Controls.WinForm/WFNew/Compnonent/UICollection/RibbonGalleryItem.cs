...
namespace GISShare.Controls.WinForm.WFNew
{
    public class RibbonGalleryItem : BaseItemStackItem, IGalleryItem, IGalleryItemEvent, IPopupOwner, IPopupOwnerHelper
    {
        ...
        private IPanelPopup m_RibbonGalleryPopup;
        ...
        //public RibbonGalleryItem(GISShare.Controls.Plugin.WFNew.IRibbonGalleryItemP pBaseItemP)
        //    : this()
        //{
        //    //IPlugin
        ...
        //    this.UpButtonIncreaseIndex = pBaseItemP.UpButtonIncreaseIndex;
        //}
        #endregion
        ...
        public virtual Point PopupLoction
        {
            get
            {
                this.m_RibbonGalleryPopup.GetPopupPanel().TrySetPopupPanelSize(new Size(60,60));
                return this.PointToScreen(this.Location);
            }
        }
        ...
        {
            get { return this.m_RibbonGalleryPopup == null ? false : this.m_RibbonGalleryPopup.IsOpened; }
        }
        ...
        {
            RibbonGalleryItem baseItem = new RibbonGalleryItem();
        ...
        protected override void MessageMonitor(MessageInfo messageInfo)
        {
            ...
            if (!this.IsOpened)
            {
                ...
                //System.Diagnostics.Debug.WriteLine(this.BaseItems[0].Name + "-" + this.BaseItems[0].Overflow.ToString() + "-" + this.ItemsRectangle + "-" + this.BaseItems[0].DisplayRectangle);
            }
        }
        ...
        private void KeepRelayoutSize()
        {
            ...
            this.Size = new Size(iMaxWidth + CTR_SCROLLAREAWIDTH + 1, this.Height);
        }
        private void Relayout(Graphics g, int topViewItemIndex)
        {
            ...
            //
            Size size = GISShare.Controls.WinForm.WFNew.LayoutEngine.LayoutStackV_LT(g, this, topViewItemIndex, false, false,
                0, -1, -1,
            ...
            //((ISetBaseItemHelper)this).SetSize(new Size(this.LockWith ? size.Width : this.Size.Width, this.LockHeight ? size.Height : this.Size.Height));
        }
