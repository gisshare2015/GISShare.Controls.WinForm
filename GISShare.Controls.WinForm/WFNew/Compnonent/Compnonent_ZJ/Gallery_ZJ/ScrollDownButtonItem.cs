...
{
    class ScrollDownButtonItem : GalleryScrollButtonItem, IBaseItemProperty
    {
        ...
        public ScrollDownButtonItem(IGalleryItem pGalleryItem)
            : base(GalleryScrollButtonStyle.eScrollDownButton)
        {
            READONLY_TimerInterval = (int)(1.5 * System.Windows.Forms.SystemInformation.DoubleClickTime);
            //
            base.Name = "GISShare.Controls.WinForm.WFNew.ScrollDownButtonItem";
            base.Text = "向下翻动";
            //
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                return this.owner.ScrollDownButtonRectangle;
            }
        }
