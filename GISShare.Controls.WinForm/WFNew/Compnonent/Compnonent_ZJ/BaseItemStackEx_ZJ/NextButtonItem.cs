...
{
    public class NextButtonItem : LTBRButtonItem, IBaseItemProperty
    {
        private readonly int READONLY_TimerInterval;
        private System.Windows.Forms.Timer m_Timer;

        private IBaseItemStackExItem owner = null;
        ...
        public override bool Visible
        {
            get
            {
                base.Visible = this.owner.OverflowItemsCount > 0;
                //
                return base.Visible;
            }
        }
