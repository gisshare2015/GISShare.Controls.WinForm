...
{
    class PreButtonTBCItem : LTBRButtonItem, IBaseItemProperty
    {
        ...
        public PreButtonTBCItem(ITabButtonContainerItem pTabButtonContainerItem)
            : base(LTBRButtonStyle.eTopButton)
        {
            READONLY_TimerInterval = (int)(1.5 * System.Windows.Forms.SystemInformation.DoubleClickTime);
            //
            base.Name = "GISShare.Controls.WinForm.WFNew.PreButtonTBCItem";
            base.Text = "前一个表按钮";
            //
            ...
            get
            {
                switch (this.owner.eOrientation)
                {
                    case Orientation.Horizontal:
                        return LTBRButtonStyle.eLeftButton;
                    case Orientation.Vertical:
                    default:
                        return LTBRButtonStyle.eTopButton;
                }
            }
        }
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                return this.owner.PreButtonRectangle;
            }
        }
