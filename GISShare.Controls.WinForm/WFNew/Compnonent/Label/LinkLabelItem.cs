...
{
    public class LinkLabelItem : LabelItem, ILinkLabelItem
    {
        #region 构造函数
        public LinkLabelItem() { }

        public LinkLabelItem(string strText)
            : base(strText) { }

        public LinkLabelItem(string strName, string strText)
            : base(strName, strText) { }

        //public LinkLabelItem(GISShare.Controls.Plugin.WFNew.ILinkLabelItemP pBaseItemP)
        //{
        //    //IPlugin
        ...
        {
            LinkLabelItem baseItem = new LinkLabelItem();
