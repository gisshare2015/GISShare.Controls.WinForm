...
namespace GISShare.Controls.WinForm.WFNew.Forms
{
        ...
        WFNew.IOwner, IOwnerNC, IBaseItemOwnerNC, IBaseItemOwnerNC2, ITBForm, IFormEvent, IUICollectionItemNC
    {
        ...
        public Rectangle CaptionRectangle
        {
            get
            {
                Size frameBorderSize = this.FrameBorderSize;
                return new Rectangle(
                    frameBorderSize.Width,
                    frameBorderSize.Height,
                    this.m_CurrentCacheSize.Width - 2 * frameBorderSize.Width,
                    this.CaptionHeight);
            }
        }
        ...
        public Rectangle CaptionIconRectangle
        {
            get
            {
                ...
                return new Rectangle
                    (
                    captionRectangle.Left + 1,
                    captionRectangle.Top + 1,
                    captionRectangle.Height - 2,
                    captionRectangle.Height - 2
                    );
            }
        }
        ...
        #region 覆盖
        //private int m_NCLeft = 0;
        //private int m_NCTop = 0;
        //private int m_NCRight = 0;
        //private int m_NCBottom = 0;
        /// <summary>
                ...
                switch (m.Msg)
                {
                    ...
                    case (int)GISShare.Win32.Msgs.WM_NCCALCSIZE:
                        ...
                        if (m.WParam == (IntPtr)1)
                        {
                            ...
                            //this.m_NCLeft = p.rect2.Left - p.rect0.Left;
                            //this.m_NCTop = p.rect2.Top - p.rect0.Top;
                            //this.m_NCRight = p.rect0.Right - p.rect2.Right;
                            //this.m_NCBottom = p.rect0.Bottom - p.rect2.Bottom;
