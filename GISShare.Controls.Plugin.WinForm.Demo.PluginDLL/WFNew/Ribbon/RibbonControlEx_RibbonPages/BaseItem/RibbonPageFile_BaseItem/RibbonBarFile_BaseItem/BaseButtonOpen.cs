...
namespace GISShare.Controls.Plugin.WinForm.Demo.PluginDLL.WFNew.Ribbon.RibbonControlEx_RibbonPages.BaseItem.RibbonPageFile_BaseItem.RibbonBarFile_BaseItem
{
    class BaseButtonOpen : GISShare.Controls.Plugin.WinForm.WFNew.BaseButtonItemP
    {
        ...
        {
            this._Name = "GISShare.Controls.Plugin.WinForm.Demo.PluginDLL.WFNew.Ribbon.RibbonControlEx_RibbonPages.BaseItem.RibbonPageFile_BaseItem.RibbonBarFile_BaseItem.BaseButtonOpen";
            this._Text = "打开";
