...
{
    class ButtonItemOpen : GISShare.Controls.Plugin.WinForm.DockBar.ButtonItemP
    {
        public ButtonItemOpen()
        {
            this._Name = "GISShare.Controls.Plugin.WinForm.Demo.PluginDLL.WinForm.DockBar.ToolBar.ToolBarFile_Item.ButtonItemOpen";
            this._Text = "打开";
