...
{
    class ButtonItemSave : GISShare.Controls.Plugin.WinForm.DockBar.ButtonItemP
    {
        public ButtonItemSave()
        {
            this._Name = "GISShare.Controls.Plugin.WinForm.Demo.PluginDLL.WinForm.DockBar.ToolBar.ToolBarFile_Item.ButtonItemSave";
            this._Text = "保存";
