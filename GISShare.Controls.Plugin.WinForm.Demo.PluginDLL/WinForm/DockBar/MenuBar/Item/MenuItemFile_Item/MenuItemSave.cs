...
{
    class MenuItemSave : GISShare.Controls.Plugin.WinForm.DockBar.MenuItemP
    {
        public MenuItemSave()
        {
            this._Name = "GISShare.Controls.Plugin.WinForm.Demo.PluginDLL.WinForm.DockBar.MenuBar.Item.MenuItemFile_Item.MenuItemSave";
            this._Text = "保存";
